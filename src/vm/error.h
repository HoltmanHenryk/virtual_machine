...
typedef enum {
    ...
    EXCEPTION_TOO_MANY_EXTERN_SYMBOLS,
    EXCEPTION_OPEN_SYSCALL_FAIL,
...
static const char *ErrorStrings[] = {
    ...
    [EXCEPTION_TOO_MANY_EXTERN_SYMBOLS] = STRINGFY(EXCEPTION_TOO_MANY_EXTERN_SYMBOLS),
    [EXCEPTION_OPEN_SYSCALL_FAIL]       = STRINGFY(EXCEPTION_OPEN_SYSCALL_FAIL),
    [EXCEPTION_STACK_OVERFLOW]          = STRINGFY(EXCEPTION_STACK_OVERFLOW),
    [EXCEPTION_STACK_UNDERFLOW]         = STRINGFY(EXCEPTION_STACK_UNDERFLOW),
